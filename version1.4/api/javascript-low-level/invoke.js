...
let orderer2_path ='/home/gautam/blockchain/artys_blockchain/artifacts/channel/crypto-config/ordererOrganizations/example.com/orderers/orderer2.example.com/msp/tlscacerts/tlsca.example.com-cert.pem'
let orderer1_path ='/home/gautam/blockchain/artys_blockchain/artifacts/channel/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem'
...
var orderercert = fs.readFileSync(orderer1_path, 'utf8');
var orderercert2 = fs.readFileSync(orderer2_path, 'utf8');
...
//////////////////////////////#######################Adding Orderer to fix code####################################///////////////////////////////


		const orderer1 = fabric_client.newOrderer('grpcs://localhost:7050', {
			'ssl-target-name-override': 'peer0.org1.example.com',
			pem: orderercert
		})
		const orderer2 = fabric_client.newOrderer('grpcs://localhost:7050', {
			'ssl-target-name-override': 'peer0.org1.example.com',
			pem: orderercert2
		})
		console.log(orderer1,'this is a new orderer 2 required')
...
//////////////////////////////#######################Adding Orderer to fix code####################################///////////////////////////////
		...
		//######################CHAINCODE IS ALREADY INITIALIZED##############################
		...
		// The artys chaincode is able to perform a few functions
		...
		const proposal_request = {
			...
			chaincodeId: 'artys',
			fcn: 'createAsset',
			args: ["utxo", "{\"id\": \"utxo2\", \"ownerId\": \"owner1\", \"amount\": 100}", "[]"],
			// fcn: 'readAsset',
			// args: ["utxo", "{\"id\": \"utxo1\",\"ownerId\": \"owner123\",}"],
			chainId: 'mychannel',
			txId: tx_id
		};
		...
		console.log('proposal was gooooooooooooddddddddd')
